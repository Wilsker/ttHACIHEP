...
void SecondStep::Process(char* inFile, string outDirPath){
  ...
  oldtree->SetBranchStatus("BJetness_avip3dval",1);
...
// WARNING:: BDT been removed to run on IHEP farm
  ...
  double BJetness_jetpt0=0;
  double BJetness_numleps=0;
  double BJetness_npvTrkOVcollTrk=0;
  double BJetness_avip3dval=0;
  double BJetness_avip3dsig=0;
  double BJetness_avsip3dsig=0;
  double BJetness_avip1dsig=0;

  TBranch *b_BJetness_jetpt0, *b_BJetness_numleps, *b_BJetness_avip3dval, *b_BJetness_avip3dsig, *b_BJetness_avsip3dsig, *b_BJetness_avip1dsig;//*b_BJetness_npvTrkOVcollTrk;
